...
import { Link, useLocation } from "react-router-dom";
  ...
  <div className="App">
    ...
    <div class="web-header">
      ...
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">酸っぱいから</Button>
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">カフェインが強いから</Button>
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">紅茶のほうが好みだから</Button>
      <div class="p-1"></div>
      <div class="p-2"></div>
