...
import { Link, useLocation } from "react-router-dom";
  ...
  <div className="App">
    ...
    <div className="web-header">
      ...
      <Button className="btn-light btn-outline-dark p-3">リラックスできるから</Button>
      <div className="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">家族や友達との時間を楽しめるから</Button>
      <div className="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">こだわりの時間を過ごせるから</Button>
      <div className="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">集中できるから</Button>
      <div className="p-2"></div>
