...
import { Link, useLocation } from "react-router-dom";
  ...
  export default function CoffeeQ1_3() {
  ...
  <div className="App">
    ...
    <div class="web-header">
      <div className="p-4">質問：コーヒーを飲んでみたいと思いますか？</div>
      <center><img src="https://fukusukecoffee.com/wp-content/uploads/2023/02/q13.png" alt="specialty-coffee" width="200px" /></center>
      <div class="p-2"></div>
      <Button className="btn-light btn-outline-dark p-3">できれば飲めるようになりたい</Button>
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">おいしいコーヒーを知りたい</Button>
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">飲まなくてもいいかな</Button>
      <div class="p-2"></div>
