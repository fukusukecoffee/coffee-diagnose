...
import { Link, useLocation } from "react-router-dom";
  ...
  <div className="App">
    ...
    <div class="web-header">
      ...
      <div class="p-2"></div>
      <Button className="btn-light btn-outline-dark p-3">毎日飲みます</Button>
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">週に数回飲みます</Button>
      <div class="p-1"></div>
      <Button className="btn-light btn-outline-dark p-3">あまり飲みません</Button>
      <div class="p-2"></div>
